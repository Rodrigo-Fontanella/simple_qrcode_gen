...
class Application:
    def __init__(self, master=None):
        ...
        # If it's not use the path we're on now
            ...
            print('Caminho diretório Raiz:', self.diretorio_programa)
        ...
        self.label2["text"] = "Onde Salvar:"
        self.label2.pack(side=LEFT)
        self.label2["font"] = self.fonteNegrito

        self.versao = Label(self.container6)
        self.versao["text"] = " Desenvolvido por Rodrigo Fontanella - Setembro de 2021 - Versão 1.0"
        self.versao["bd"] = "3"
        self.versao["bd"] = "2"
        ...
        # self.destino_path = ""
        self.destino.insert(0, (os.path.dirname(__file__) + "/exportado/"))

        # Buttons
        self.bot_destino = Button(self.container4)
        self.bot_destino["text"] = "Buscar"
        ...
        self.botao1["text"] = "Gerar QR Code"
    ...
    def on_click(self):
        ...
        self.continuar = messagebox.askyesno(
            "QR Code Generator", "O QR Code será gerado com os dados inseridos. Deseja continuar?")
        ...
        if self.continuar:
            ...
            if self.end_url != "" and self.end_destino != "":
                ...
                print("Cor Interna", self.colorintr.get(), self.colorintg.get(), self.colorintb.get())
                print("Cor externa", self.colorextr.get(), self.colorextg.get(), self.colorextb.get())
                print(self.end_img)
                ...
                if self.end_img != "":
                    ...
                    img_simbolo.save(self.end_destino + "/" + "qrcode_simbolo.png")
                    print("Gerou PNG com Imagem dentro")
                ...
                print("Gerou PNG Cantos Arredondados")
                ...
                img_tudo = qr.make_image(image_factory=StyledPilImage, module_drawer=RoundedModuleDrawer(),
                                         ...
                                         color_mask=RadialGradiantColorMask(back_color=(255, 255, 255),
                                                                            ...
                                                                            edge_color=(int(self.colorintr.get()),
                                                                                        int(self.colorintg.get()),
                                                                                        int(self.colorintb.get()))))
                img_tudo.save(self.end_destino + "/" + "qrcode_tudo.png")
                print("Gerou PNG com todos os efeitos")

                self.showinfo = messagebox.showinfo("QR Code Generator", "QR Code gerado com Sucesso!")

            elif self.end_url == "":
                self.showinfo = messagebox.showinfo("Atenção",
                                                    "Favor preencher o Endereço de URL.")

            elif self.end_destino == "":
                self.showinfo = messagebox.showinfo("Atenção",
                                                    "Favor preencher o Endereço de Destino.")
                ...
                self.showinfo = messagebox.showinfo("Atenção",
                                                    "Favor preencher os dados! Mínimo: URL e Destino.")
